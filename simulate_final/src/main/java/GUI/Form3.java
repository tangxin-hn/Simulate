...
public class Form3 extends JFrame {
	...
	public Form3() {
		...
		JLabel lblNewLabel = new JLabel("R1\u6267\u884C\u7684Pauli\u9635");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("微软雅黑", Font.PLAIN, 15));
		lblNewLabel.setBounds(10, 63, 141, 27);
		frame.getContentPane().add(lblNewLabel);

		JLabel lblSpauli = new JLabel("R2\u6267\u884C\u7684Pauli\u9635");
		...
		label1_0.setText(Show.r1[0][0]);
		label1_1.setText(Show.r1[0][1]);
		label1_2.setText(Show.r1[1][0]);
		label1_3.setText(Show.r1[1][1]);

		label2_0.setText(Show.r2[0][0]);
		label2_1.setText(Show.r2[0][1]);
		label2_2.setText(Show.r2[1][0]);
		label2_3.setText(Show.r2[1][1]);
