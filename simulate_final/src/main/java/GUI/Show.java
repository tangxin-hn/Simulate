...
public class Show extends JFrame {
	...
	String[][] mr = new String[2][2];
	static String[][] vs1 = new String[4][4];
	static String[][] vs2 = new String[4][4];
	static String[][] s1 = new String[2][2];
	static String[][] s2 = new String[2][2];
	static String[][] r1 = new String[2][2];
	static String[][] r2 = new String[2][2];
	...
	JTextField textField_16;// A1
	JTextField textField_17;// A2
	JTextField textField_18;// B1
	JTextField textField_19;// B2
	...
	public void initialize() {
		...
		btnNewButton_1.setBounds(689, 67, 132, 40);
		frame.getContentPane().add(btnNewButton_1);

		JLabel label_1 = new JLabel(
				"\u9884\u8BA1\u7ED3\u679C\uFF1A");
		label_1.setFont(new Font("微软雅黑", Font.PLAIN, 17));
		label_1.setBounds(65, 157, 104, 32);
		...
		textField_17.setBounds(472, 290, 133, 25);
		frame.getContentPane().add(textField_17);

		JLabel lblb = new JLabel("\uFF083,B1\uFF09");
		lblb.setFont(new Font("微软雅黑", Font.PLAIN, 17));
		lblb.setBounds(615, 256, 70, 23);
		frame.getContentPane().add(lblb);

		JLabel lblb_1 = new JLabel("\uFF086,B2\uFF09");
		lblb_1.setFont(new Font("微软雅黑", Font.PLAIN, 17));
		lblb_1.setBounds(615, 289, 70, 23);
		frame.getContentPane().add(lblb_1);

		textField_18 = new JTextField();
		textField_18.setFont(new Font("微软雅黑", Font.PLAIN, 13));
		textField_18.setColumns(10);
		textField_18.setBounds(688, 257, 133, 25);
		frame.getContentPane().add(textField_18);

		textField_19 = new JTextField();
		textField_19.setFont(new Font("微软雅黑", Font.PLAIN, 13));
		textField_19.setColumns(10);
		textField_19.setBounds(688, 290, 133, 25);
		...
		button.setBounds(689, 117, 132, 40);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				sim.mySimulate(a0, b0, a1, b1);// 只运行一次

				s = sim.getOutput();// 13个值
				mr = sim.getMeasurementResult();// A1,B1,A2,B2

				vs1 = sim.getStringVS1();
				vs2 = sim.getStringVS2();
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (textField_6.getText().equals("")) {
					...
					textField_16.setText(mr[0][0]);
					textField_17.setText(mr[1][1]);
					textField_18.setText(mr[0][1]);
					textField_19.setText(mr[1][1]);

				} else {
					if (textField_7.getText().equals("")) {
						textField_7.setText(s[4]);
						textField_12.setText(s[5]);
						// 这里弹出Form1，在Form1里取vs1和vs2的值
						Form1 f1 = new Form1();
